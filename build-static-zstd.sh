...
cd file
autoreconf -f -i
cp -r /usr/local/xzmm/* /usr/local
LDFLAGS="-static --static -no-pie -s" ./configure --prefix=/usr/local/filemm  --enable-static --disable-shared --enable-zlib --enable-xzlib --enable-zstdlib
make
make install
